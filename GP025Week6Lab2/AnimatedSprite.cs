...
namespace Sprites
{
    public class Sprite
    {
        ...
        public float SpriteRrotation = (float)(Math.PI / 2);
        ...
        {
            //spriteBatch.Begin();
            //spriteBatch.Draw(spriteImage, position, sourceRectangle, Color.White, SpriteRrotation, Vector2.Zero, 1.0f, _effect, 0f);
            Vector2 origin = new Vector2(spriteWidth / 2f, spriteHeight / 2f);
            spriteBatch.Draw(spriteImage, position, sourceRectangle, Color.White, SpriteRrotation, origin, 1.0f, _effect, 0f);
